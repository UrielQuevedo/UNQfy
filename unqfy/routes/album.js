...
router.post('/', (connection.executeFunction(['artistId','name','year'],(unqfy, req, res) => {
  ...
  unqfy.sendInfoToLog({ message: 'Se agrego el album ' + album.name, levelMessage: 'info'});
...
router.delete('/:id', (connection.executeFunction([],(unqfy, req, res) => {
  ...
  unqfy.sendInfoToLog({ message: 'Se elimino el album ' + album.name, levelMessage: 'info'});
